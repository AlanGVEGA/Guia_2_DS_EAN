        ...
        if (comando.equals(CANCELAR)) {
            ...
            if (nombreNuevo.equals("") || tipoStr.equals("") || valorStr.equals("") || cantBodegStr.equals("") || cantMinStr.equals("") || imagenStr.equals("")) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(this, "El valor unitario, cantidad en bodega, cantidad minima deben ser valores num�ricos.", "Cambiar producto", JOptionPane.ERROR_MESSAGE);
                }
            }
