...
public class InterfazTienda extends JFrame {
    ...
    /**
     * Abastece una cantidad de unidades del producto con el nombre dado por par�metro.
     * @param pNombreProducto Nombre del producto. pNombreProducto != null && pNombreProducto != "".
     */
        ...
        if (pCant != null) {
            try {
                ...
                if (cantidad > 0) {
                    ...
                    actualizar();
                    if (abastecio) {
                        JOptionPane.showMessageDialog(this, "Se abastecio la tienda.", "Abastecer producto", JOptionPane.INFORMATION_MESSAGE);
                    } else {
    ...
    public void reqFuncOpcion2() {
        ...
        actualizar();
        JOptionPane.showMessageDialog(this,
                "El producto mas barato se llama: " + resultado,
                "Producto barato",
                JOptionPane.INFORMATION_MESSAGE);
    }
